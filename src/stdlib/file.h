...
bool read_file(const char* filename, list_u8* list) {
...
bool write_file(const char* filename, list_u8* list) {
    // try to open the file specified, return false if not openable
